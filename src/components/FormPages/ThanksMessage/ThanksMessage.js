...
import './ThanksMessageStyle.css'
export const ThanksMessage = ({ setPageNumber }) => {
    ...
    return (
        <div className='thank-msg-container'>
            ...
            <p>Thanks for confirming your subsription! We hope you have fun using our platform. if you ever need support, please feel free to email us at support@loremgaming.com.</p>
        </div>
    )
}
